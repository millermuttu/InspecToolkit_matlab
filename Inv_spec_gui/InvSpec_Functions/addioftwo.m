function [WL_A,WL_B,T_A,T_B,outwl,resTX] = addioftwo(hObject,handles)
handles
...
[r,s]=size(T_B);
Res_WL=[];
%%--------Addition: samples of equal size-------
...
%  plot( outwl,resTX);  
    ...
    %%----------------Addition: Samples of different size--------
...
% plot(out2);
% hold on
% plot(out1);xlabel('wavelength');ylabel('Transmittance');
...
handles.val=k;
handles.listboxItems{k} = strcat(str1,str2,'_Added');
