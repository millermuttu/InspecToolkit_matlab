function [ wavelength_mean,wavelength_accuracy,wavelength_repeatability,max_wavelength_shift_row_nm,peak_fwhm_mean,Absorbance_accuracy,Absorbance_repeatability] = figuremeri_water( X,lambda,ftir_peak_loc,ftir_peak_values )
