function [ wavelength_mean,wavelength_accuracy,wavelength_repeatability,max_wavelength_shift_row_nm,peak_fwhm_mean,Absorbance_accuracy,Absorbance_repeatability] = figuremeri_ETH(X,lambda,ftir_peak_loc,ftir_peak_values )
data_string = {'C002','C006','T003','T004'};
% ftir_peak_loc = [6.3859 7.4406 8.1507 9.803];
% ftir_peak_values = [0.76089 0.36335 0.7199 0.80478];
%%
